...
# Validate GPU type
case $GPU_TYPE in
    k80|v100|a100|p100|v100x)
        ;;
    *)
        echo "Warning: Unknown GPU type '$GPU_TYPE'. Valid types: k80, p100, v100, v100x, a100"
        ;;
esac
...
echo "======================================================================"
echo ""
echo "IMPORTANT: Use timestamped log directories to preserve logs."
echo ""
echo "1. Create required directories:"
echo "   mkdir -p $OUTPUT_DIR"
echo "   mkdir -p $RESULTS_DIR"
echo "   mkdir -p $LOG_DIR/run_$TIMESTAMP"
echo ""
...
echo "       --partition gpu --gres=gpu:k80:1 \\"
echo "       --logdir $LOG_DIR/test_$TIMESTAMP"
echo ""
echo "3. Full production run (K80 GPUs recommended - test other types first):"
echo "   swarm -f $OUTPUT_SWARM \\"
echo "       -g 64 -t 16 --time 06:00:00 \\"
echo "       --partition gpu --gres=gpu:k80:1 \\"
echo "       --logdir $LOG_DIR/run_$TIMESTAMP"
echo ""
echo "   # To test on other GPU types, change --gres=gpu:TYPE:1 where TYPE is:"
echo "   # k80, p100, v100, v100x, a100"
...
echo ""
echo "6. Preserve logs - never delete log directories:"
echo "   ls $LOG_DIR/  # View all log runs by timestamp"
echo ""
echo "======================================================================"
